...
<head>
    ...
    <style type="text/css">
        ...
        .alert {
            ...
            padding: 10px;
            color: #000; /* White text for alerts */
        }
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="div_center">
                        <h2 class="h2_form">Create New User</h2>
                        ...
                        <div class="center">
                            <form action="{{ url('/store_user') }}" method="POST">
                                ...
                                <div class="div_design">
                                    ...
                                    <input type="text" class="input_color" name="name" placeholder="Enter User Name" required>
                                </div>

                                <div class="div_design">
                                    <label for="email">Email:</label>
                                    <input type="email" class="input_color text-black" name="email" placeholder="Enter User Email" required>
                                </div>

                                <div class="div_design">
                                    <label for="adress">Address:</label>
                                    <input type="text" class="input_color" name="address" placeholder="Enter User Address" required>
                                </div>    

                                <div class="div_design">
                                    <label for="adress">phone:</label>
                                    <input type="text" class="input_color" name="phone" placeholder="Enter User Phone" >
                                </div>
                                ...
                                <div class="div_design">
                                    ...
                                    <div style="position: relative;">
                                        ...
                                        <span id="eye-icon" class="eye-icon text-black" onclick="togglePassword()">👁️‍🗨️</span>
                                    </div>
                                </div>
                                ...
                                <div class="div_design">
                                    <input type="submit" class="submit_ct" value="Create User">
                                </div>
                            </form>
                        </div>
                    </div>
