              ...
              <div class="row">
                <div class="col-9">
                  <div class="d-flex align-items-center align-self-start">
                    ...
                    <p class="text-danger ml-2 mb-0 font-weight-medium">Customers</p>
                  </div>
                </div>
                <div class="col-3">
          ...
          <div class="card">
            <div class="card-body">
              <div class="row">
                <div class="col-9">
                  <div class="d-flex align-items-center align-self-start">
                    <h3 class="mb-0">{{$total_deliverd}} </h3>
                    <p class="text-success ml-2 mb-0 font-weight-medium">orders</p>
                  </div>
                </div>
                <div class="col-3">
              ...
              <h6 class="text-muted font-weight-normal">Orders Deliverd</h6>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <h6 class="text-muted font-weight-normal">Orders Proccessing</h6>
            </div>
          </div>
        </div>
